      ...
      <section className="hero">
        <div className="hero-left">
          <motion.h1 variants={textVariants} initial="hidden" animate="visible" custom={0}>
            Welcome to AION AI, your Cryptocurrency guide and prediction model
          </motion.h1>

          <motion.p variants={textVariants} initial="hidden" animate="visible" custom={1}>
            Dive into the world of cryptocurrencies and stocks with AION AI. We provide cutting-edge analysis,
